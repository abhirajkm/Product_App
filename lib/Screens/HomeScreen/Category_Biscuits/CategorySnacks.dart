...
class CategorySnacks extends StatefulWidget {
  const CategorySnacks({Key key}) : super(key: key);

  @override
  _CategorySnacksState createState() => _CategorySnacksState();
}

class _CategorySnacksState extends State<CategorySnacks> {
  String Biscuits="";
  String Snacks="";
